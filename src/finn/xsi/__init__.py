...
def status() -> None:
    ...
    if is_available():
        ...
        available_funcs = [
            'compile_sim_obj', 'get_simkernel_so', 'load_sim_obj',
            'reset_rtlsim', 'close_rtlsim', 'rtlsim_multi_io', 'SimEngine'
        ]
...
_ADAPTER_FUNCTIONS = [
    'locate_glbl', 'compile_sim_obj', 'get_simkernel_so', 
    'load_sim_obj', 'reset_rtlsim', 'close_rtlsim', 'rtlsim_multi_io'
]
